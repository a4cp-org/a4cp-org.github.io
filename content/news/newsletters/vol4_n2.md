...
aliases:
  - /old_nodes/842
title: "Volume 4, Number 2, July 2008"
date: 2026-07-25T15:05:57+0200
draft: false
---
...
* [news](#news): report from the ACP EC, honours to members of the CP community, ICAPS 2010 call for proposals, Minion Users Group Call for Members, News from the AFPC
* [CONSTRAINTS journal accepted papers](file:///D:/mgelain/Desktop/cpnews.v4.n2.html#_CONSTRAINTS_Journal_Accepted)
* [Constraint Programming Letters journal accepted papers](file:///D:/mgelain/Desktop/cpnews.v4.n2.html#_Constraint_Programming_Letters)
* [other publications](file:///D:/mgelain/Desktop/cpnews.v4.n2.html#_Other_Publications): books, software
* [special issues cfps](file:///D:/mgelain/Desktop/cpnews.v4.n2.html#_Special_Issues_CFPs)
* [events](file:///D:/mgelain/Desktop/cpnews.v4.n2.html#events): forthcoming conferences and workshops
* [career news](file:///D:/mgelain/Desktop/cpnews.v4.n2.html#career): new PhD and Postdoc positions
* [report:](file:///D:/mgelain/Desktop/cpnews.v4.n2.html#_Reports) SAT-Race 2008 by Carsten Sinz
...
      Please send your nominations to [Jimmy Lee](mailto:jlee@cse.cuhk.edu.hk) to arrive by midnight (California time) on August 10th, 2008.
...
Pedro Meseguer and Francesca Rossi, both members of the ACP Executive Committee, were elected [ECCAI fellows](http://www.eccai.org/fellow.php).

Peter van Beek and Toby Walsh were elected [AAAI Fellows](http://www.aaai.org/Awards/fellows-list.php).
...
Proposals to host ICAPS should be sent electronically (PDF file) to: [icaps-council@googlegroups.com](mailto:icaps-council@googlegroups.com)

Please submit proposals by Thursday July 31, 2008

Proposers are welcome to submit draft proposals before that deadline. Please get in touch with the Conference Liaison Officer [Shlomo Zilberstein](mailto:shlomo@cs.umass.edu) for
...
Clearly the closer to the deadline, the harder it will be to offer feedback. Information about previous and next ICAPS conferences is available at [Guidelines for Conference Organizers](http://rbr.cs.umass.edu/ICAPS-Guidelines.pdf)

Minion Users Group Call for Members

Minion is a open source constraint solver currently developed by a team at Oxford and St Andrews University.  Full details of the solver can be found [here](http://minion.sourceforge.net/).  We hope that this will be a place where all users of Minion can discuss any questions they have with regard to the constraints solver.  If you have any problems using Minion than this is the place to come to for help.  However, please also feel free to discuss features you would like Minion to have and any other related material here.  Basically, if you have anything to say about the Minion constraint solver this is the place to say it.  Please visit [here](https://mail.cs.st-andrews.ac.uk/mailman/listinfo/mug) to join the mailing list.

News from the AFPC

The fourth French-Speaking Constraint Programming Days ([JFPC](http://www.lina.sciences.univ-nantes.fr/JFPC08/jfpc08/)) took place during the first days of June in Nantes, France. Around 40 papers were presented during those 3 days. The programme committee was chaired by Gilles Trombettoni.

On June 4th, the general assembly of the French Association for Constraint Programming ([AFPC](http://www.afpc-asso.org/)) took place. A new Administrative Council whose president is Narendra Jussien and vice-president Christine Solnon have been elected.  The next few months will see the following topics being addressed:
...
The contents of the most recently completed issue are listed below.  Links to the authors' final versions of these papers (no subscription required) and to the final published versions (subscription required) can be found [here](http://ai.uwaterloo.ca/%7Evanbeek/Constraints/constraints.html).
...
* Special Issue on Parallel SAT Solving  
  [Journal of Satisfiability](http://jsat.ewi.tudelft.nl/)  
  Deadline for paper submission: November 30th, 2008  
    
  Guest Editors:  
  Youssef Hamadi, Microsoft Research, [youssefh@microsoft.com](mailto:youssefh@microsoft.com)

## Events

* [SMT-COMP 2008](http://www.smtcomp.org/), 4th International Satisfiability Modulo Theories Competition, July 7 - 14, 2008, Princeton, USA.
* [MPREF-08](http://wikix.ilog.fr/wiki/bin/view/PreferenceWS/MdPref08), 4th Multidisciplinary Workshop on Advances in Preference Handling ([AAAI-08](http://www.aaai.org/Conferences/AAAI/aaai08.php) Workshop), July 13-14, 2008, Chicago, Illinois.
* [AAAI-08](http://www.aaai.org/Conferences/AAAI/aaai08.php) [Workshop on Search in Artificial Intelligence and Robotics](http://www.uwosh.edu/faculty_staff/furcyd/search_symposium_2008/), July 13-14, 2008 (directly before AAAI) in Chicago, IL, USA.
...
* [CHR 2008](http://www.uni-ulm.de/in/pm/research/events/chr2008), Fifth Workshop on Constraint Handling Rules (Co-located with [RTA 2008](http://www.risc.uni-linz.ac.at/conferences/rta2008/)), July 14, 2008, Hagenberg, Austria.
...
* [UNIF 2008](http://www.score.cs.tsukuba.ac.jp/%7Emmarin/UNIF2008/), 22nd International Conference on Unification, July 18, 2008, Castle of Hagenberg, Austria.
* [ACM PPDP 2008](http://www.clip.dia.fi.upm.es/Conferences/PPDP08), 10th ACM-SIGPLAN International Symposium on Principles and Practice of Declarative Programming, July 15-17, 2008, Valencia, Spain.
* [MoChArt-2008](http://www.csc.liv.ac.uk/%7Emjw/mochart/), Fifth Workshop on MODEL CHECKING and ARTIFICIAL INTELLIGENCE (At [ECAI-2008](http://www.ece.upatras.gr/ecai2008/)), July 2008, Patras, Greece.
* Workshop on [INFERENCE METHODS BASED ON GRAPHICAL STRUCTURES OF KNOWLEDGE](http://www.irit.fr/LC/) (associated with [ECAI 2008](http://www.ece.upatras.gr/ecai2008/)), 21st or 22nd July, 2008, Patras, Greece.
* Workshop on [Modeling and Solving Problems with Constraints](http://www.cs.uwaterloo.ca/%7Ecquimper/modeling) (held in conjunction with [ECAI 2008](http://www.ece.upatras.gr/ecai2008/)), July 21-22, 2008, Patras, Greece.
* [AIG-08](http://www.plg.inf.uc3m.es/ecai-aig2008/), The Workshop on AI in Games (Held at [ECAI-08](http://www.ece.upatras.gr/ecai2008/)), Patras, Greece, July, 2008.
* [ECAI 2008](http://www.ece.upatras.gr/ecai2008/) Workshop on [Configuration Systems](http://www.soberit.hut.fi/configws08), July 21 - 22, 2008, Patras, Greece.
...
* [ARW'08](http://events.cs.bham.ac.uk/cicm08/workshops/arw/), 2008 Workshop on Automated Reasoning: Bridging the Gap between Theory and Practice, 30th-31st July 2008, University of Birmingham.
* [CoSyScaRe 08](http://www.dfki.de/cosyscare/), Workshop on Combining Systems for Efficient and Scalable Reasoning, 10/11 August, 2008, Sydney, Australia.
* [CFV'08](http://www.miroslav-velev.com/cfv08.html), Fifth International Workshop on Constraints in Formal Verification (a satellite event of IJCAR'08), August 11, 2008, Sydney, Australia.
...
* [Third International CSP Solver Competition](http://cpai.ucc.ie/) (competition workshop affiliated with [CP 2008](http://www.csse.unimelb.edu.au/cp2008/)), September 14-15, 2008, Sydney, Australia.
* [Soft'08](http://soft08.ecs.soton.ac.uk/), 9th Workshop on Preferences and Soft Constraints (in conjunction with [CP 2008](http://www.csse.unimelb.edu.au/cp2008/)), Sept 15, 2008, Sydney, Australia.
* [Counting'08](http://carlit.toulouse.inra.fr/cgi-bin/awki.cgi/CountingWorkshop), First Workshop on Counting Problems in CSP and SAT, and other neighbouring problems (in conjunction with [CP 2008](http://www.csse.unimelb.edu.au/cp2008/)), Sept 14, 2008, Sydney, Australia.
* [QiCP'08](http://www.univ-orleans.fr/lifo/evenements/QiCP2008/), Second International Workshop on Quantification in Constraint Programming--- "Beyond Existentially Quantified Variables" (held in conjunction with [CP 2008](http://www.csse.unimelb.edu.au/cp2008/)), Sept 14, 2008, Sydney, Australia.
* [SymCon'08](http://www.aloul.net/symcon), The Eighth International Workshop on Symmetry in Constraint Satisfaction Problems (held in conjunction with [CP 2008](http://www.csse.unimelb.edu.au/cp2008/)), Sept 14, 2008, Sydney, Australia.
* [COPLAS'08](http://www.dsic.upv.es/%7Emsalido/workshop-cp-icaps08/index.html), CP/ICAPS 2008 Joint Workshop on Constraint Satisfaction Techniques for Planning and Scheduling Problems, September 14, 2008, Sydney, Australia.
* [ModRef'08](http://www.it.uu.se/research/group/astra/ModRef08/), The 7th International Workshop on Constraint Modelling and Reformulation (held in conjunction with [CP 2008](http://www.csse.unimelb.edu.au/cp2008/)), Sept 15, 2008, Sydney, Australia.
* [LSCS'08](http://sysrun.haifa.il.ibm.com/hrl/lscs2008/), The 5th International Workshop on Local Search Techniques in Constraint Satisfaction (held in conjunction with [CP 2008](http://www.csse.unimelb.edu.au/cp2008/)), Sept 15, 2008, Sydney, Australia.
* [CP 2008](http://www.csse.unimelb.edu.au/cp2008/), 14th International Conference on Principles and Practice of Constraint Programming (co-located with [ICAPS'08](http://icaps08.icaps-conference.org/)), September 14 - 18, 2008, Sydney, Australia.
* [S P A R K](http://decsai.ugr.es/%7Elcv/SPARK/index.html), Scheduling and Planning Applications woRKshop (an [ICAPS'08](http://icaps08.icaps-conference.org/) Workshop), Sept 15, 2008, Sydney, Australia.
* [ICAPS'08](http://icaps08.icaps-conference.org/) [Multiagent Planning Workshop](http://masplan.isr.ist.utl.pt/), September 14 or 15, 2008, Sydney, Australia.
* [KEPS2008](http://kti.mff.cuni.cz/%7Ebartak/KEPS2008/), Knowledge Engineering for Planning and Scheduling (an International Workshop to be co-located with [ICAPS'08](http://icaps08.icaps-conference.org/)), September 14 or 15, 2008, Sydney, Australia.
* [A Reality Check for Planning and Scheduling Under Uncertainty](http://www.ai.sri.com/%7Ebryce/ICAPS08-workshop.html) (an [ICAPS'08](http://icaps08.icaps-conference.org/) Workshop), September 15, 2008, Sydney, Australia.
* [ICAPS'08](http://icaps08.icaps-conference.org/) [Oversubscribed Planning and Scheduling Workshop](http://www.contrib.andrew.cmu.edu/%7Elaurabar/icaps08-wkshp/index.html), September 14 or 15, 2008, Sydney, Australia.
* [ICAPS'08](http://icaps08.icaps-conference.org/), International Conference on Automated Planning and Scheduling (co-located with [CP 2008](http://www.csse.unimelb.edu.au/cp2008/)), September 14-18, 2008, Sydney, Australia.
* [SCHEALS'08](http://www.tadbirstm.org.ir/), International Workshop on Scheduling in Healthcare Systems (in conjunction with [ICAOR'08](http://www.tadbirstm.org.ir/)), 15-16 September 2008, Yerevan, Armenia.
* [ICAOR'08](http://www.tadbirstm.org.ir/), 1st International Conference on Applied Operational Research, 15-17 September 2008, Yerevan, Armenia.
...
* [WLP 2008](http://nirvana.informatik.uni-halle.de/%7Eschwarz/wlp2008/), 22nd Workshop on (Constraint) Logic Programming, September 30 - October 1, 2008, Dresden, Germany.  Paper submission deadline: July 20, 2008.
* [ICTAI 2008](http://dblab.cs.wright.edu/ictai2008/), The 20th IEEE INTERNATIONAL CONFERENCE on TOOLS with ARTIFICIAL INTELLIGENCE, November 3-5, 2008, Dayton, Ohio, USA.
* [LaSh08](http://www.cs.kuleuven.be/%7Edtai/LaSh08), WORKSHOP ON LOGIC AND SEARCH: Computation of structures from declarative descriptions, November 6-7, 2008, Leuven, Belgium.  Paper submission deadline: August 15, 2008.
* [LPAR 2008](http://www.qatar.cmu.edu/lpar08/), 15th International Conference on Logic for   Programming, Artificial Intelligence and Reasoning, November 22-27, 2008, Doha, Qatar.
* [AI 2008](http://www.ai08.org/), Twenty-first Australasian Joint Conference on Artificial Intelligence, 1 - 5 December, 2008, Auckland, New Zealand.
* Fourth Doctoral Consortium, [ICLP'08](http://www.cs.kuleuven.be/%7Etoms/DC2008/), 24th International Conference on Logic Programming, December 9th-13th, 2008, Udine, Italy.  Submission deadline: August 25, 2008.
* [15th RCRA workshop](http://www.dis.uniroma1.it/%7Ercra08): Experimental evaluation of algorithms for solving problems with combinatorial explosion (co-located with [ICLP'08](http://www.cs.kuleuven.be/%7Etoms/DC2008/)), December 9th-13th, 2008, Udine, Italy.  Abstract submission deadline: 1 September, 2008.  Papers submission deadline: 15 September, 2008.
* [ICLP'08](http://iclp08.dimi.uniud.it/), 24th International Conference on Logic Programming, December 9th-13th, 2008, Udine, Italy.
* [PRICAI 2008](http://www.jaist.ac.jp/PRICAI-08/), Tenth Pacific Rim International Conference on Artificial Intelligence, 15-19 December, 2008, Hanoi, Vietnam.
...
* Track on [Constraint Solving and Programming](http://www.sci.unich.it/%7Ebista/organizing/constraint-sac2009/) (part of the 24th Annual ACM Symposium on Applied Computing), March 8 - 12, 2009, Waikiki Beach, Honolulu, Hawaii, USA.  Paper submission deadline: August 16, 2008.
...
PhD opportunities at the [KRDB Research Centre](http://www.inf.unibz.it/krdb/), Faculty of Computer Science, Free University of Bozen-Bolzano, Italy
...
Other research topics are listed in the personal [web pages of the members of the KRDB Centre](http://www.inf.unibz.it/krdb/staff.php).
...
[THE KRDB RESEARCH CENTRE](http://www.inf.unibz.it/krdb/index.php)
...
  Email: [calvanese@inf.unibz.it](mailto:calvanese@inf.unibz.it)  
  Phone: +39-0471-016-160  
  Fax: +39-0471-016-009

The [current PhD students](https://www.inf.unibz.it/phd/) can be contacted for more information.

## POSTDOCTORAL RESEARCHER: 'DESIGNING MECHANISMS FOR AUTOMATED RESOURCE ALLOCATION' LOUGHBOROUGH UNIVERSITY -- DEPARTMENT of COMPUTER SCIENCE
...
## Closing date    1 August 2008 Position Reference      CO/13034 Minimum start salary    GB Pounds 25,888 per annum

## Informal enquires may be addressed to:

## Dr S. Fatima Department of Computer Science Loughborough University Loughborough LE11 3TU United Kingdom Tel: +44 (0) 1509 222 677 Fax: +44 (0) 1509 211 586 Email: [S.S.Fatima@lboro.ac.uk](file:///D:/mgelain/Desktop/S.S.Fatima@lboro.ac.uk)

## NOTE: Curriculum Vitae will only be accepted when accompanied by a completed University application form. Full details and application pack can be found [here](http://www.loughborough-university-jobs.co.uk/).

## \*\* Please quote Ref: CO/13034 in all enquiries \*\*

## Open Position in Computational Social Choice at University of Munich PhD Student or Post-Doc
...
## To be considered for the position, please forward a detailed curriculum vitae and selected publications (master or diploma thesis when applying for the PhD position) to [Felix Brandt](mailto:brandtf@tcs.ifi.lmu.de). Please use "CFSC" in the subject line. Applications will be accepted until the position is filled.
...
## Further information about the project can be obtained from [Prof. Krzysztof R. Apt](mailto:apt@cwi.nl). More information about the research carried out in the PNA1 group can be found [here](http://www.cwi.nl/org). Applicants are expected to have a proven research experience in the mentioned research areas.
...
## Applications, mentioning "DIACoDeM Project", with enclosures a curriculum vitae, a list of publications and a list of references should be sent to [K.R. Apt](mailto:apt@cwi.nl).

## 

## Reports

#### Report on SAT-Race 2008 Carsten Sinz
...
In 2009 there will be [another SAT Competition](http://www.satcompetition.org/), which will be organized in conjunction with the SAT 2009 conference to be held in Swansea, UK.

Further information on SAT-Race 2008 can be found on the [web](http://www-sr.informatik.uni-tuebingen.de/sat-race-2008).
