...
aliases:
  - /old_nodes/851
title: "Volume 2, Number 0, January 2006"
...
#### Editors: [Jimmy Lee](http://www.cse.cuhk.edu.hk/%7Ejlee/) (events, career news) [Eric Monfroy](http://www.sciences.univ-nantes.fr/info/perso/permanents/monfroy/) (profiles, publications) [Toby Walsh](http://www.cse.unsw.edu.au/%7Etw/) (news, reports)

## Contents

* [news](#news): ACP News, AAAS Fellow, CP-2005 Pictures, CONSTRAINTS Journal New Policy on Originality, ACP Summer School 2006, CP 2006, CP 2007
* [CONSTRAINTS journal accepted papers](#_CONSTRAINTS_Journal_Accepted_Papers)
* [other publications](#_Other_Publications): book, phd theses, special issues, LMCS, TPLP Special Issue in CHR, book review, software
* [events](#events): forthcoming conferences and workshops
* [career news](#career): Doctoral, Postdoc, Researcher, and Intern positions
* [reports](#_Report_1): CHR 2005 Second Workshop on Constraint Handling Rules
* [profile](#_Profile): ASTRA Research Group at Uppsala University, Sweden
...
- The ACP has decided to start a travel grant scheme for CP students or researchers in need to go to CP-related conference. Details about this will be posted on the [www.a4cp.org](http://www.cse.cuhk.edu.hk/%7Ejlee/www.a4cp.org) web site and sent to all relevant mailing lists.
...
- [Second International Summer School of the Association for Constraint Programming](http://www.cse.unsw.edu.au/%7Etw/school.html)
...
More details can be found under "[Instructions for Authors](http://ai.uwaterloo.ca/%7Evanbeek/Constraints/constraints.html)".
...
The Constraints Journal publishes 4 times per year. The contents of the first three issues of 2006 (in progress) are listed below. Links to the authors' final versions of these papers (no subscription required) and to the final published versions (subscription required) can be found [here](http://ai.uwaterloo.ca/%7Evanbeek/Constraints/constraints.html).
...
Peter Zoeteweij.  [Composing Constraint Solvers](http://www.st.ewi.tudelft.nl/%7Epeterz/thesis/pz-thesis.pdf), Universiteit van Amsterdam.  Supervisors: K.R. Apt and F. Arbab.
...
[Heikel Batnini](http://www-sop.inria.fr/coprin/batnini).  Global Constraints and Splitting Strategies for Continuous CSPs (in french), INRIA Sophia Antipolis.  Supervisor: M. Rueher.
...
Andrei Legtchenko.  [Apprentissage de solveurs de contraintes sur les domaines finis Finite domain constraint solver learning](http://legtchenko.free.fr/papers/PhD_Legtchenko2005.zip) (in french), d'Orléans (Laboratoire d'Informatique Fondamentale d'Orléans, LIFO).  Supervisors: Arnaud Lallouet and Christel Vrain. 
...
[Special Issue](http://www.csse.monash.edu.au/%7Embanda/tplp_special_implementation) of Theory and Practice of Logic Programming on Implementation of Logic Programming Systems.  Guest Editors: Bart Demoen and Maria Garcia de la Banda.  Paper submission deadline: June 15, 2006. 

#### Logical Methods in Computer Science

We are writing to inform you about the progress of the open-access, online journal "Logical Methods in Computer Science," which has recently benefited from a freshly designed [web site](http://www.lmcs-online.org/).
...
You will find more information about it [here](http://www.dashoptimization.com/home/products/products_kalis.html) or [here](http://kalis.artelys.com/).
...
2. A new event type "dom\_any(X,E)" is provided, which captures exclusions of arbitrary elements from the domain of X. This event is useful for implementing the AC-4 algorithm for arbitrary support constraints, as demonstrated by the solver for this year's [solver competition](http://www.probp.com/mosar/).

3. Improvements of constraint propagators for binary inequality constraints, reification constraints, and global constraints (element, all\_distinct, and circuit). B-Prolog continues to provide a leading technology for constraint solving. See the latest [benchmarking results](http://www.probp.com/benchmark_clpfd.htm).

In addition to these major improvements, there are many minor changes.  Please see [here](http://www.probp.com/updates.htm) for more details.
...
[2006 Special Programme on Logic and Algorithms](http://www.newton.cam.ac.uk/programmes/LAA/ws.html) (6 Workshops).  16 January - 7 July 2006, Isaac Newton Institute for Mathematical Sciences at Cambridge, UK. 
...
[WLP 2006](http://www.kr.tuwien.ac.at/wlp06), 20th Workshop on Logic Programming.  February 22 - 24, 2006, Vienna University of Technology, Austria. 
...
[DALT 2006](http://www.illc.uva.nl/%7Eulle/DALT-2006/), 4th International Workshop on Declarative Agent Languages and Technologies (held in conjunction with AAMAS 2006).  8 May 2006, Future University Hakodate, Japan.  Paper submission deadline: 15 January 2006.

[CLIMA VII](http://research.nii.ac.jp/climaVII/), Seventh International Workshop on Computational Logic in Multi-Agent Systems (held in conjunction with AAMAS 2006).  May 8,9 2006, Future University, Hakodate, Japan.  Paper submission deadline: 15 January 2006. 

[FLAIRS 06](http://www.cs.fit.edu/%7Emsilaghi/FLAIRS06/), Track on Secure Multiparty Computations and Distributed Constraint Reasoning.  May 11-13, 2006, Holiday Inn Melbourne Beach, FL, USA.

[INCOM06](http://www.emse.fr/incom2006), 12th IFAC Symposium on Information Control Problems in Manufacturing (a Series of Special Sessions on Value-Chain Optimisation using Constraint Programming).  May 17 - 19, 2006, Saint-Etienne, France.

[CP-AI-OR'06](http://tidel.mie.utoronto.ca/cpaior), The Third International Conference on Integration of AI and OR Techniques in Constraint Programming for Combinatorial Optimization Problems.  May 31-June 2, 2006, Cork, Ireland.  Paper submission deadline: January 9, 2006.

[ICAPS-06](http://icaps06.icaps-conference.org/), The 16th International Conference on Automated Planning and Scheduling.  June 6-10, 2006, The English Lake District, Cumbria, U.K. 

[ISSAC 2006](http://issac2006.dima.unige.it/), International Symposium on Symbolic and Algebraic Computation.  July 9 - 12, 2006, Genoa, Italy.  Paper submission deadline: January 11, 2006 (Midnight [24:00EST]). 

The AAAI-06 [Workshop on Learning for Search](http://www.cs.ubc.ca/%7Ehutter/aaai06_ws).  July 16/17, 2006, Boston, Massachusetts.  Paper submission deadline: March 31, 2006.
...
[ICLP'06](http://www.cs.uky.edu/iclp06/), 22nd International Conference on Logic Programming (Part of Fourth Federated Logic Conference, FLoC 2006).  17-20 August, 2006, Seattle, Washington, USA.  Abstracts submission deadline: 14 February, 2006.  Paper submission deadline: 21 February, 2006. 

[ECAI 2006](http://ecai2006.itc.it/), 17th European Conference on Artificial Intelligence.  August 28th - September 1st 2006, RIVA DEL GARDA, Italy.  Paper submission deadline: 10 Feb 2006. 

[SAS'06](http://ropas.snu.ac.kr/sas06), The 13th International Static Analysis Symposium.  29-31 August 2006, Seoul, Korea.  Paper submission deadline: 7 April 2006.
...
[CP 2006](http://www.sciences.univ-nantes.fr/cp06/), 12th International Conference on Principles and Practice of Constraint Programming, Sept 25-29, 2006, Nantes, France.
...
[CSL'06](http://www.inf.u-szeged.hu/%7Ecsl06/), Annual Conference of the European Association for Computer Science Logic.  September 25 -- 29, 2006, Szeged, Hungary.  Title & Abstract Submission deadline: 24 April, 2006.  Full Paper Submission deadline: 1 May, 2006. 

[ADVIS 2006](http://web.deu.edu.tr/advis), Fourth Biennial International Conference on Advances in Information Systems, 18-20 October, 2006, Izmir, Turkey.  Paper submission deadline: April 1, 2006. 
...
Interested parties please contact [Prof. Gene Freuder](mailto:e.freuder@4c.ucc.ie).

Further information about the [Cork Constraint Computation Centre](http://www.4c.ucc.ie/) and about [Microsoft Research Cambridge](http://research.microsoft.com/aboutmsr/labs/cambridge/default.aspx.) can be found by following the links.
...
     Email: [bart.demoen@cs.kuleuven.be](mailto:bart.demoen@cs.kuleuven.be)
...
To apply for an internship with Microsoft Research at Cambridge, please complete our [online Internship Application](http://www.research.microsoft.com/aboutmsr/jobs/internships/cambridge.aspx).
...
Please be aware that if you do not complete the application fully your application will not be processed.  Should you have and questions concerning your application or regarding internships at the Cambridge Lab please email [cambtern@microsoft.com](mailto:cambtern@microsoft.com).

## POST-DOC POSITION IN CONSTRAINT-BASED SCHEDULING
...
Prospective applicants should email their CV to [James Little](mailto:j.little%20@4c.ucc.ie) by December 8th 2005.
...
  [Günter Landsmann](http://www.risc.uni-linz.ac.at/people/homepage.cgi?query=3Dgland)
...
Interested parties should visit the [online application](http://nicta.com.au/jobs.html).      

## 

## Reports

[Second Workshop on Constraint Handling Rules](http://www.cs.kuleuven.ac.be/%7Etoms/CHR2005/) held at Sitges (Spain) at the occasion of ICLP'05 October 5, 2005
...
The final discussion comprised future research plans and topics: CHR as business rules, analysis, implementation, the G12 project...  Also a call for active participation was made in the [CHR website](http://www.cs.kuleuven.ac.be/%7Edtai/projects/CHR/) and [mailinglist](http://listserv.cc.kuleuven.ac.be/archives/chr.html). In particular, it was agreed to collect ideas for PhDs and other research topics on the CHR website.
...
[Analysis, Synthesis, and Transformation / Reformulation](http://www.it.uu.se/research/group/astra/)

[of Algorithms in constraint technology](http://www.it.uu.se/research/group/astra/)
...
Nationally, we are the founding node of [SweConsNet](http://www.it.uu.se/research/SweConsNet/), the Network for Sweden-based researchers and practitioners of Constraint technology.

Internationally, our group is an Affiliated Member of the ERCIM Working Group on Constraints, as well as part of the Uppsala University node of CoLogNET, the European Network of Excellence in Computational Logic.  We are the founders of the [SymCon](http://www.it.uu.se/research/group/astra/SymCon/) series of international workshops on symmetry in CSPs.
...
We teach the advanced undergraduate course "[Constraint Technology for Solving Combinatorial Problems](http://www.it.uu.se/edu/course/homepage/constech/)".  It is also open to graduate students, as a multi-disciplinary graduate course in the Faculty of Science and Technology.

More information on the ASTRA group can be found on the [web](http://www.it.uu.se/research/group/astra/).
