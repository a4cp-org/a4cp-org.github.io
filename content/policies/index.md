...
The open exchange of ideas is central to the mission of the Association for Constraint Programming (ACP). This requires an environment that embraces diversity and provides a safe, welcoming environment for all. As a result, in 2018 the ACP adopted the following anti-harassment policy (based on the one adopted by the ACM also in 2018) to be observed during all ACP activities

[Read more about Anti-Harassment Policy](/events/anti-harassment-policy)
