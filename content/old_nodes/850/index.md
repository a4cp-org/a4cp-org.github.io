---
title: "Volume 2, Number 1, April 2006"
date: 2026-07-25T15:06:04+0200
draft: false
---
...
* [news](#news): ACP News, ACP Summer School 2006, CP 2006, CP 2007, CP-AI-OR, ERCIM Workshop on Constraints, Yahoo! Discussion Group on Constraints
* [CONSTRAINTS journal accepted papers](#_CONSTRAINTS_Journal_Accepted_Papers)
* [other publications](#_Other_Publications): book, phd theses, special issues, book review, software
...
[Second International Summer School of the Association for Constraint Programming](http://www.cse.unsw.edu.au/%7Etw/school.html "http://www.cse.unsw.edu.au/~tw/school.html")  
[http://www.cse.unsw.edu.au/~tw/school.html](http://www.cse.unsw.edu.au/~tw/school.html "http://www.cse.unsw.edu.au/~tw/school.html")
...
<http://tidel.mie.utoronto.ca/cpaior/index.php?n=Main.AcceptedPapers>
...
<http://tidel.mie.utoronto.ca/cpaior/index.php?n=Main.MasterClass>

REGISTRATION DETAILS

<http://tidel.mie.utoronto.ca/cpaior/index.php?n=Main.Registration>
...
     <http://centria.di.fct.unl.pt/conferences/csclp06>
...
<http://groups.yahoo.com/group/constraints/>
...
The Constraints Journal publishes 4 times per year. The contents of the current issue and forthcoming papers are listed below. Links to the authors' final versions of these papers (no subscription required) and to the final published versions (subscription required) can be found [here](http://ai.uwaterloo.ca/~vanbeek/Constraints/constraints.html).
...
Florian Letombe. [De la validité des formules booléennes quantifiées : étude de complexité et exploitation de classes traitables au sein d'un prouveur QBF](http://www.cril.univ-artois.fr/~letombe/TheseFlorianLetombe-13-12-05.ps.gz) (in french). Université d'Artois (UFR Lens)
...
#### Julien Bidot. [A General Framework Integrating Techniques for Scheduling under Uncertainty](http://scheduler.ilog.fr/). ILOG S.A. in collaboration with Laboratoire Génie de Production de l'Ecole Nationale d'Ingénieurs de Tarbes.
...
You probably know Sudokus .... but do you know that Sudokus can be easily solved using Constraint Programming? We recently published an article about  this topic on [http://www.java.net](http://www.java.net/):
...
  - [http://sudoku.koalog.com](http://sudoku.koalog.com/),
...
  - [**http://www.lemonde.fr**](http://www.lemonde.fr/) (starting this week).
...
More info on http[://www.koalog.com/php/jcs.php](:/www.koalog.com/php/jcs.php).
...
On 2005/11/04, we were invited by Narendra Jussien at the Ecole des Mines de Nantes ([http://www.emn.fr](http://www.emn.fr/)) to give a talk about Koalog Constraint Solver.
...
Koalog Configurator comes with an intuitive Swing maintenance tool and efficient web components. A car configurator example built with Koalog Configurator web components can be seen at [http://democonfig.koalog.com](http://democonfig.koalog.com/).
...
Visit [http://www.koalog.com](http://www.koalog.com/) for additional information about Koalog.
...
  For more information please visit: [http://jopt.sourceforge.net](http://jopt.sourceforge.net/)
...
The class LP\_Problem can be used to represent, check the satisfiability and optimize linear programming problems.  The solver is based on a primal simplex algorithm using exact arithmetic.
...
<http://www.acm.org/conferences/sac/sac2006/pages/tracks.htm>
...
<http://www.illc.uva.nl/~ulle/DALT-2006/>
...
<http://www.cs.fit.edu/~msilaghi/FLAIRS06/>
...
<http://www.loria.fr/~ranise/calculemus06>
...
<http://www.aaai.org/Conferences/National/2006/aaai06.html>
...
[http://www.ismp2006.org](http://www.ismp2006.org/)
...
<http://fmv.jku.at/ecai-config-ws-2006>
...
[http://patat06.muni.cz](http://patat06.muni.cz/)
...
[http://www.or2006.de](http://www.or2006.de/)
...
[http://aimsa2006.inrialpes.fr](http://aimsa2006.inrialpes.fr/)
...
[http://www.MICAI.org/2006](http://www.micai.org/2006)
...
  Web:    [http://4c.ucc.ie](http://4c.ucc.ie/)
...
[http://www.grlmc.com](http://www.grlmc.com/)
