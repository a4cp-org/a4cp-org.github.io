...
I believe CP has always been at its best when it stays open to ideas from related fields. The influence of SAT techniques on modern CP solvers is a good example of how much can be gained from this kind of cross-pollination, and there are promising signs of the same happening with other paradigms. I think there is still much more to gain from engaging with communities like automated planning and beyond. If elected, I would like to help encourage this kind of exchange, whether through co-location, shared workshops, or simply making it easier for researchers with new solving approaches to see CP as a natural home for their work. I am also keen to see our benchmarking infrastructure continue to evolve, drawing on what I have learned from competition organisation.
I would be glad to contribute to the work of the EC and to support the community that has shaped much of my research career.
