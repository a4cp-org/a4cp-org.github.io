---
title: "Volume 1, Number 3, October 2005"
date: 2026-07-25T15:06:07+0200
draft: false
---
...
* [news](#news): ACP Awards, ACP EC Elections, Next CP Conferences, CONSTRAINTS Journal Call for Papers
* [CONSTRAINTS journal accepted papers](#_CONSTRAINTS_Journal_Accepted_Papers)
* [other publications](#_Other_Publications): books, special issues, software
* [events](#events): forthcoming conferences and workshops
* [career news](#career): Young Research programme, and Postdoc and Associate/Visiting Researcher position
* [reports](#_Report_1): CP Summer School, and IJCAI'05 Workshop on Modelling and Solving Problems with Constraints
* [profile](#_Profile): CLP Group at CharlesUniversity, Prague
...
Further information can be found [here](http://ai.uwaterloo.ca/~vanbeek/Constraints/constraints.html).
...
#### [Yong Gao](http://www.cs.ualberta.ca/~ygao/), PhD (University of Alberta), Phase transitions and typical-case complexity: Easy (Hard) Aspects of Hard (Easy) Problems, 2005. Suprvised by Dr. Joe Culberson.

#### Operations research techniques in constraint programming, Willem Jan van Hoeve, Institute for Logic, Language and Computation, Universiteit van Amsterdam, 2005-04-19.  Access it [here](http://dare.uva.nl/en/record/149602) or [here](http://www.cs.cornell.edu/~vanhoeve/). Keywords: Operations research; mathematical programming; constraints (information science)

#### Special issues

1.  European Journal of Operational Research, [Special Issue on 'Scheduling with Setup Times or Costs'](http://www.elsevier.com/wps/find/S03.cws_home/eor8).  Guest editors: Ali Allahverdi and H.M. Soroush.  Paper submission deadline: Dec 31, 2005.

2.   AI Communications, [Special Issue on "Constraint Programming for Planning and Scheduling"](http://4c.ucc.ie/~carchrae/wiki/index.php?n=Main.AIComCfp).  Guest editors:
...
Paper submission deadline: Nov. 15th, 2005.  Please submit papers in .pdf format by e-mail to [brahim@4c.ucc.ie](mailto:brahim@4c.ucc.ie)
...
Visit [here](http://www.koalog.com/php/jcs.php) for documentation, code examples,KCS release notes.
...
Visit [here](http://www.koalog.com/) for additional information.

2.      Alice 1.2 released

      We are happy to announce [version 1.2 of the Alice programming system](http://www.ps.uni-sb.de/alice/).
...
     For a detailed list of changes please see [here](http://www.ps.uni-sb.de/alice/download/CHANGES).
...
[Doctoral Programme](http://www.iiia.csic.es/cp2005/Calls/cfDoctoralProgram.html), Eleventh InternationalConference on Principles and Practice of Constraint Programming (CP 2005).October 1-5 2005, Sitges, Spain. 

[CPAI'05](http://cpai.ucc.ie/05/CPAI.html), Second International Workshop on Constraint Propagation and Implementation (held in conjunction with CP 2005).  October 1, 2005, Sitges, Spain.  Co-located with ICLP and an annular eclipse. 

[Soft 2005](http://www.inra.fr/bia/T/degivry/soft2005/), 7th International Workshop on Preferences and Soft Constraints (held in conjunction with CP 2005).  October 1st, 2005, Sitges, Spain. 
...
[LSCS 2005](http://www.haifa.il.ibm.com/projects/verification/octopus/lscs05/), Second International Workshop on Local Search Techniques in Constraint Satisfaction (held in conjunction with CP 2005).  October 1st, 2005, Sitges, Spain. 

[The Fourth International Workshop on Modelling and Reformulating Constraint Satisfaction Problems](http://4c.ucc.ie/~brahim/cp05ws/) (held in conjunction with CP 2005).  October 1st, 2005, Sitges, Spain. 
...
[CHANGES'05](http://www.cs.ucc.ie/~kb11/CP2005Changes/), International Workshop on Constraint Solving under Change and Uncertainty (held in conjunction with CP 2005).  October 1st, 2005, Sitges, Spain. 

[First International Workshop on Quantification in Constraint Programming](http://www.icsd.aegean.gr/lecturers/konsterg/qcp2005.htm) (held in conjunction with CP 2005).  October 1st, 2005, Sitges, Spain. 
...
[CPSec'05](http://www.sci.unich.it/~bista/organizing/cpsec/), 1st International Workshop on Applications of Constraint Satisfaction and Programming to Computer Security (held in conjunction with CP 2005).  October 1st, 2005, Sitges, Spain.   

[First International Workshop on CONSTRAINTS AND DESIGN](http://www.cs.ucc.ie/~osullb/cad05/) (held in conjunction with CP 2005).  October 1st, 2005, Sitges, Spain. 

[COSOLV 2005](http://www.sciences.univ-nantes.fr/info/perso/permanents/granvil/cosolv/2005/), 5th CP Workshop on Cooperative Solvers in Constraint Programming (held in conjunction with CP 2005).  October 1st, 2005, Sitges, Spain.

[SymCon'05](http://www.cs.brown.edu/people/sello/symcon/), The Fifth International Workshop on Symmetry and Constraint Satisfaction Problems (held in conjunction with CP 2005).  October 1st, 2005, Sitges, Spain. 

[CP 2005](http://www.iiia.csic.es/cp2005/), 11th International Conference on Principles and Practice ofConstraint Programming.  October 1-5 2005, Sitges, Spain.Co-located withICLP and an annular eclipse. 

[Doctoral Consortium](http://www.cs.nmsu.edu/~epontell/DC2005), Twenty first International Conference on Logic Programming.  2-5 October, 2005, Sitges, Spain.Co-located with CP 2005 and an annular eclipse. 

[CHR 2005](http://www.cs.kuleuven.be/~toms/CHR2005/), Second Workshop on Constraint Handling Rules (co-located with ICLP'05).  October 5, 2005, Sitges (Barcelona) Spain. 

[CSLP 2005](http://control.ruc.dk/CSLP2005.html), 2nd International Workshop on Constraint Solving and Language Processing (co-located with ICLP 2005).  5 October 2005, Sitges, Barcelona, Spain. 

[CICLOPS 2005](http://www.dcc.fc.up.pt/ciclops05), Colloquium on Implementation of Constraint and LOgic Programming Systems (Satellite workshop of ICLP 2005).  October 5, 2005, Sitges (Barcelona), Spain. 
...
[MoVeLog'05](http://babel.ls.fi.upm.es/movelog05), Mobile Code Safety and Program Verification Using Computational Logic Tools (an ICLP 2005 Workshop).  Sitges, Spain, Oct. 5, 2005. 

[WLPE05](http://lml.ls.fi.upm.es/~susana/Conferences/WLPE05/index.html), The 15th Workshop on Logic-based methods in Programming Environments (Satellite workshop of ICLP 2005).  October 5, 2005, Sitges (Barcelona), Spain. 

[ICLP'05](http://www.iiia.csic.es/iclp2005/), Twenty first International Conference on Logic Programming.  2-5October, 2005, Sitges, Spain.Co-located with CP 2005 and an annulareclipse. 
...
[INAP2005](http://inap.dialogengines.com/), 16th International Conference on Applications of Declarative Programming and Knowledge Management.  October 22-24, 2005, WasedaUniversity, Fukuoka, Japan. 

[ISCIS'05](http://iscis05.cmpe.boun.edu.tr/) The 20th International Symposium on Computer and InformationSciences.  October 26-28, 2005 - Istanbul, Turkey.

Heuristic Methods for Timetabling and Rostering (Special Invited Session ofINFORMS'05).  November 13-16, 2005, New Orleans, USA.  Contact Dario LandaSilva at [jds@cs.nott.ac.uk](mailto:jds@cs.nott.ac.uk).

[INFORMS'05](http://www.informs.org/Conf/NO2005/index.htm), 2005 INFORMS Annual Meeting.  November 13-16, 2005, NewOrleans, USA. 

[ICTAI 2005](http://ictai05.ust.hk/), 17th IEEE International Conference on Tools with ArtificialIntelligence.  November 14-16, 2005, Hong Kong.   

[MICAI 2005](http://www.micai.org/2005), 4th Mexican International Conference on ARTIFICIALINTELLIGENCE.  November 14-18, 2005, Monterrey, Mexico.

[MLS+CP,](http://webhost.ua.ac.be/eume/workshops/mlscp) Workshop on Combination of metaheuristic and local search withConstraint Programming techniques.  November 28-29, 2005, University of

Nantes, Nantes - France.  Access the workshop site [here](http://ppcro.free.fr/mlscp.html) too.

[LPAR-12](http://www.lpar.net/2005), The 12th International Conference on Logic for Programming Artificial Intelligence and Reasoning.  2nd-6th December 2005, Montego Bay, Jamaica. 

[PLANSIG 2005](http://www.soi.city.ac.uk/~cf609/SIG2005.htm), The 24th Workshop of the UK PLANNING AND SCHEDULING Special Interest Group.  December 15-16, 2005, CityUniversity, London, U.K.  Deadline for submissions: 5th October 2005
...
[PADL'06](http://www.cs.brown.edu/people/pvh/PADL06.html), Eighth International Symposium on Practical Aspects of Declarative Languages 2006 (co-located with ACM POPL'06).  January 9-10, 2006, Charleston, South Carolina, USA. 

[Special semester on Gröbner Bases and Related Methods 2006](http://www.ricam.oeaw.ac.at/srs/groeb/).  February - July, 2006, Linz and Hagenberg, Austria.

[WLP 2006](http://www.kr.tuwien.ac.at/wlp06), 20th Workshop on Logic Programming.  February 22 - 24, 2006, ViennaUniversity of Technology, Austria.  Paper submission deadline: November 14, 2005.

[AAAI-06](http://www.aaai.org/Conferences/National/2006/aaai06.html), Twenty-First National Conference on Artificial Intelligence.  July16-20, 2006, Boston, Massachusetts, USA.  Paper submission deadline: February 21, 2006.

[IJCAR 2006](http://ijcar06.uni-koblenz.de/), Third International Joint Conference on Automated Reasoning.  August 16-21, 2006, Seattle, USA.  Paper registration deadline: Feb 27, 2006.  Full paper submission deadline: Mar 6, 2006.

[PATAT 2006](http://patat06.muni.cz/), the 6th International Conference on the Practice and Theory of Automated Timetabling.  August 30 - September 1, 2006, Brno, Czech Republic.  Paper submission deadline: January 27, 2006.
...
[ICAPS-06](http://icaps06.icaps-conference.org/), The 16th International Conference on Automated Planning and Scheduling.  June 6-10, 2006, The English Lake District, Cumbria, U.K.  Abstract Submission Deadline: November 11, 2005.  Paper Submission Deadline: November 14, 2005. 

[PRICAI'06](http://www.csse.monash.edu.au/pricai06), The Ninth Pacific Rim International Conference on Artificial Intelligence.  7-11th August, 2006, Guilin, China.  Paper submission deadline: 22nd February, 2006. 

[FLAIRS 06](http://www.cs.fit.edu/~msilaghi/FLAIRS06/), Track on Secure Multiparty Computations and Distributed Constraint Reasoning.  May 11-13, 2006, Holiday Inn Melbourne Beach, FL, USA.  Paper submission deadline: November 21, 2005.

[AISC-2006](http://www.cc4cm.org/aisc2006/), AI and Symbolic Computation, September 20-22, 2006, Beijing, China.  Paper submission deadline: April 7, 2006.

## Career news

**Young Researcher Position available****.****ISAAC Project****,** **ITC-IRST,** **Trento****,** **Italy**

The Automated Reasoning Systems Division (SRA) at [ITC-irst](http://sra.itc.it/) is seeking a young researcher to join the team ofthe ISAAC project. The position lasts up to January 2007 and is already open. Monthly salaries vary depending on age, qualification, and experience.

The ISAAC Project

The ISAAC project ([AST3-CT-2003-501848](http://www.cert.fr/isaac/))  -- Improvement of Safety Activities on Aeronautical Complex Systems -- is a Specific Targeted Research Project sponsored by the European Commission under the 6th Framework Program. The ISAAC consortiumcomprises aeronautical industries (AleniaAeronautica, Airbus France, Airbus UK, Airbus Germany, Saab AB, Societa' ItalianaAvionica, Dassault Aviation) and research centers leaders in formal verification, safety assessment, and tool development (ITC-irst, ONERA CERT, Kuratorium OFFIS e. V., ProverTechnologyAB).

The goal of the ISAAC project is to define a methodology, based on formal methods, to improve the safety analysis practice for complex systems development in the aeronautic field, to set up a shared environment based on tools supporting the methodology, and to validate the methodology through its application to case-studies. The ISAAC project builds upon the results of the [ESACS](http://www.cert.fr/esacs/) project.
...
    [isaac-recruit@itc.it](mailto:isaac-recruit@itc.it)
...
They are several postdoctoral positions open in the area of constraint programming and scheduling. One position has a deadline of Oct 16th. The other is ongoing.  There are also PhD positions and scholarships available for overseas applicants.  Please contact [Toby Walsh](mailto:tw@cse.unsw.edu.au) for more details.

**Associate / Visiting researcher position in Constraint Programming**

[LIFO](http://www.univ-orleans.fr/lifo/) - University of Orleans, France
...
Funding is provided by an association called "[The Studium](http://lestudium.cnrs-orleans.fr/home.htm)" which also provides a wide range of services to the invited researchers.  Monthly salary may vary according to experience starting from Eu 1800 after taxes, plus free furnished appartment according to family needs (worth Eu 800-1000+).

Orleans is an historic city in the middle of the LoireValley, famous by its numerous castles.  Orleans is 1 hour south of Paris by train. [The 100 hectares wooden campus](http://www.univ-orleans.fr/index.php?ln=en) is located in the south of town, with an efficient transportation to the city center ensured by a tramway line (30 mn).

Interested candidates should contact [Arnaud Lallouet](mailto:Arnaud.Lallouet@lifo.univ-orleans.fr) and send their CV, a statement of research and names of references.

## 

## Reports

1.   [The First International Summer School on Constraint Programming](http://www.math.unipd.it/~frossi/cp-school/) (Reported by Krzysztof Apt, MichelaMilano, and Francesca Rossi)
...
2.   [The First International Summer School on Constraint Programming](http://www.math.unipd.it/~frossi/cp-school/) (Reported by Roland Martin, DarmstadtUniv. of Technology)
...
3.  [The Fifth Workshop on Modelling and Solving Problems with Constraints](http://4c.ucc.ie/~brahim/ijcai05ws/), held alongside the [Nineteenth International Joint Conference on Artificial Intelligence (IJCAI 2005)](http://ijcai05.csd.abdn.ac.uk/) (Reported by ZeynepKiziltan)
...
      In addition to the paper presentations, the workshop hosted the [first constraint modelling challenge](http://www.dcs.st-and.ac.uk/~ipg/challenge/) organised by Barbara Smith and Ian Gent. It is unfortunate that the invited speaker NarendraJussien could not make the workshop, as otherwise the participants would have learnt more about modelling and solving constraint problems using the open-source constraint programming system Choco.  However, we wish all the best to his new born baby.
...
*Visopt**ShopFloor: On the edge of planning and scheduling*R. Barták. In Principles and Practice of Constraint Programming (CP2002), Springer Verlag, LNCS 2470, 2002, pp. 587-602.

*Dynamic Global Constraints in Backtracking Based Environments*R. Barták. Annals of Operations Research (2003), no. 118, p. 101-119.

*Unary Resource Constraint with Optional Activities*P. Vilím, R. Barták, O. Čepek. In Mark Wallace (ed.): Principles and Practice of Constraint Programming (CP 2004). Springer Verlag, LNCS 3258, 2004, pp. 62-76.

*Limited Assignments: A New Cutoff Strategy for Incomplete Depth First Search*R. Barták, H. Rudová. In Applied Computing 2005, Volume 1, ACM, 2005, pp. 388-392.
